...
Современный fullstack-проект для хакатона Univer Liga, построенный на монолитной архитектуре с использованием Docker. Для демонстрации возможностей настроен стартовый скрипт /backend/src/services/seed.ts

## 📚 Содержание

- [🏆 Univer Liga Hack](#-univer-liga-hack)
